<div class="modal fade text-left" id="addCategory" tabindex="-1" role="dialog" aria-labelledby="myModalLabel10"
    aria-hidden="true">
    <form class="modal-dialog modal-dialog-centered needs-validation" novalidate action="{{ route('admin.category-articles.store') }}"
        method="POST" role="document">
        @csrf
        <div class="modal-content">
            <div class="modal-header bg-info py-1 white">
                <h4 class="modal-title white text-capitalize">ajouter une nouvelle catégorie d'articles</h4>
