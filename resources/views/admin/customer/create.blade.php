...
@section('content-header')
    @include('includes.content-header', [
        'page' => 'Client',
        'breadcrumbs' => [
            ['text' => 'Client', 'link' => route('admin.clients.index')],
                ...
                <div class="card">
                    ...
                    <div class="card-content collpase show">
                        <div class="card-body">
                            ...
                            <div class="card-text">
                                <p> Formulaire pour ajouter un nouveau client</p>
                            </div>
                            ...
                            <form novalidate action="{{ route('admin.clients.store') }}" method="POST"
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="form-group row mx-auto">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" id="identification" class="form-control" required placeholder="Identification"
                                                name="identification">
                                    ...
                                    <div class="form-group row mx-auto">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" id="address" required class="form-control" placeholder="Adresse"
                                                name="address">
                                                <div class="invalid-feedback">
