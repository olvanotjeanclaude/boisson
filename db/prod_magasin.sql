...
--
-- Hôte : localhost:3306
-- Généré le : mer. 26 oct. 2022 à 14:24
-- Version du serveur :  10.3.36-MariaDB-cll-lve
...
--
-- Base de données : `u0857742_magasin`
--
...
CREATE TABLE `customers` (
  ...
  `note` text COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'description de l''utilisateur',
  `user_id` bigint(20) UNSIGNED NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(129, '2022_10_23_204427_add_sub_amount_col_to_sale', 38),
(130, '2022_10_24_104051_add_customer_id_to_sale', 38);
...
(1, 1, 365, '2022-10-13 21:42:51', '2022-10-26 11:06:29');
...
(21, 1, 1, 'olvanot jean claude', 'rakotonirina', '99000000000', '2022-05-16', 'olvanotjcs@gmail.com', '0340000000', 'storage/users/17052022070535-2730.jpg', 'demo', '$2y$10$j.g3OMHnZDn79O8YKp5D3OGpqt9MjTyWmly9WHK9LjwaE1nhxBS.C', 'demo', '2022-05-11 11:58:09', '2022-05-17 04:46:35');
...
--
-- Index pour la table `document_achats`
--
ALTER TABLE `document_achats`
  ADD PRIMARY KEY (`id`);

--
-- Index pour la table `document_ventes`
--
ALTER TABLE `document_ventes`
  ADD PRIMARY KEY (`id`);
...
--
-- Index pour la table `pricing_supliers`
--
ALTER TABLE `pricing_supliers`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT pour la table `document_achats`
--
ALTER TABLE `document_achats`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `document_ventes`
--
ALTER TABLE `document_ventes`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT pour la table `pricing_supliers`
--
ALTER TABLE `pricing_supliers`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
